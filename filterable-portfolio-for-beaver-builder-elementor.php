<?php
/**
 * Plugin Name: Xpro Portfolio For Beaver Builder - Lite
 * Plugin URI: https://beaver.wpxpro.com/
 * Description: Organize and create a responsive portfolio with one click. Easily drag and drop images in pre-built gallery layouts.
 * Version: 1.5.2
 * Author: Xpro
...
define( 'XPRO_PORTFOLIO_FOR_BB_LITE_DIR', plugin_dir_path( __FILE__ ) );
define( 'XPRO_PORTFOLIO_FOR_BB_LITE_URL', plugins_url( '/', __FILE__ ) );

final class Xpro_Portfolio_for_BB {
	...
	public function __construct() {
		...
		do_action( 'xpro_portfolio_for_bb_loaded' );
	}
	...
	public function init() {
		...
		require_once XPRO_PORTFOLIO_FOR_BB_LITE_DIR . 'classes/class-xpro-portfolio-lite-wp-init.php';
	}
		...
		if ( 'plugins' === $screen->base ) {
			if ( file_exists( WP_PLUGIN_DIR . '/xpro-addons-beaver-builder-elementor/xpro-addons-beaver-builder-elementor.php' ) ) {
				...
				/* translators: 1: Plugin name 2: Beaver Builder */
					...
					'<strong>' . esc_html__( 'Xpro Portfolio For Beaver Builder – Lite', 'xpro-bb-addons' ) . '</strong>',
	...
	public function admin_notice_minimum_php_version() {
		...
		/* translators: 1: Plugin name 2: PHP 3: Required PHP version */
			...
			'<strong>' . esc_html__( 'Xpro Filterable Portfolio', 'xpro-bb-addons' ) . '</strong>',
...
// Instantiate Xpro_Portfolio_for_BB.
new Xpro_Portfolio_for_BB();
